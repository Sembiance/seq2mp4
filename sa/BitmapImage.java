...
public class BitmapImage
    ...
    public int convertToChunky(int top, int left, int bottom, int right) {
        ...
        //System.out.println("BitmapImage.toChunky elapsed:"+(System.currentTimeMillis()-start)+" pixelType="+pixelType_);
        return pixelType;
    }
    ...
    private void directPlanesToDirectPixels(int top, int left, int bottom, int right) {
        ...
        oldend = newstart = System.currentTimeMillis();
        iPixel = 0;*/
        int iBit, bitMask;
        for (iScanline = top * scanlineStride; iScanline < bottomScanline; iScanline += scanlineStride) {
            for (x = left; x < right; x++) {
        ...
        System.out.println("BitmapImage direct2direct old="+(oldend-oldstart)+" new="+(newend-newstart));
         */
    }
    ...
    private void ham6PlanesToDirectPixels(int top, int left, int bottom, int right) {
       ...
       // final int bitplaneStride1 = bitplaneStride;
        ...
        newstart = oldend = System.currentTimeMillis();
        iPixel = 0;
        ...
        /*
        newend = System.currentTimeMillis();
        System.out.println("BitmapImage ham6todirect old="+(oldend-oldstart)+" new="+(newend-newstart));
         */
    }
    ...
    private void ham8PlanesToDirectPixels(int top, int left, int bottom, int right) {
        ...
        newend = System.currentTimeMillis();
        System.out.println("BitmapImage ham8todirect old="+(oldend-oldstart)+" new="+(newend-newstart));
         */
    }

/*
 * @(#)SEQMovieTrack.java  1.0  2010-12-25
 *
...
public class SEQMovieTrack {
     ...
     * Should not be stored here since it is
    ...
    private Hashtable<String, Object> properties_ = new Hashtable<String, Object>();
    /** Anim frames. */
    private Vector<SEQFrame> frames_ = new Vector<SEQFrame>();
    ...
    public void setSwapSpeakers(boolean newValue) {
        ...
        /*if (newValue != oldValue) {
            for (Enumeration<SEQFrame> i = frames_.elements(); i.hasMoreElements();) {
    ...
    private void firePropertyChange(String name, int oldValue, int newValue) {
        listeners_.firePropertyChange(name, Integer.valueOf(oldValue), Integer.valueOf(newValue));
    }
    ...
    public synchronized long getTotalDuration() {
        if (totalDuration_ == -1) {
            ...
            for (int i = getFrameCount() - 1; i > -1; i--) {
                totalDuration_ += getFrameDuration(i) + 1;
            }
        }
